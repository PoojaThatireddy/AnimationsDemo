...
//        setContentView(R.layout.activity_url_media_player1);
        ...
        final String audioFile = intent.getStringExtra(UrlMediaPlayer.AUDIO_URL);
        final String coverImage = intent.getStringExtra(UrlMediaPlayer.IMG_URL);
